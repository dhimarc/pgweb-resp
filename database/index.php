...
$data=query("SELECT*FROM warmindo");
...
<body>
<h1>Persebaran Warmindo</h1>
<a href="tambah.php">Tambah Data Survei</a>
<br></br>
...
<a href="delete.php?id=<?=$row["id"];?>"onclick="return confirm('Apakah Anda Ingin Menghapus Data ?');">delete</a>
 ...
 <td><?=$row["nama_warmindo"];?></td>
 <td><?=$row["latitude"];?></td>
 <td><?=$row["longitude"];?></td>
 <td><img src="img/<?=$row["foto"];?>" width="200"></td>
 </tr>
 <?php $i++;?>
 <?php endforeach;?>
 </body>
